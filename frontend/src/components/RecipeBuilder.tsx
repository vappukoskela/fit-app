...
interface RecipeBuilderProps {
    ...
    onUpdateIngredient: (i: number, field: "amount_g" | "note", value: string) => void
...
export const RecipeBuilder = ({
    ...
    // TODO: Fix the jankiness here. Good enough for now.
    ...
    }, [recipeIngredients, recipe.servings])
                                                ...
                                                <CardContent className="p-3">
                                                    ...
                                                    <div className="grid grid-cols-2 gap-2 mb-2">
                                                        <Input
                                                            ...
                                                            value={ri.amount_g}
                                                            onChange={(e) => onUpdateIngredient(index, 'amount_g', e.target.value)}
                                                        />
                                                        <Input
